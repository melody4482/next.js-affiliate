...
export default () => {
  return (
    <Box sx={{ flexGrow: 1 }}>
      <StyledNavbar>
        <Toolbar style={{ justifyContent: "space-between", padding: '5px 10px' }}>
          <Link className="next-link" href="/">
            <Image width={50} height={50} alt="logo" src={`/logo.png`}></Image>
          </Link>
          <div>
            <Link className="next-link" href="/ad-manager">Ad Management</Link>
            <Link className="next-link" href="/">Dashboard</Link>
          </div>
        </Toolbar>
      </StyledNavbar>
    </Box>
